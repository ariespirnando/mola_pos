...
abstract class _$$SideMenuStateImplCopyWith<$Res>
  ...
  factory _$$SideMenuStateImplCopyWith(
          _$SideMenuStateImpl value, $Res Function(_$SideMenuStateImpl) then) =
...
class __$$SideMenuStateImplCopyWithImpl<$Res>
  ...
  __$$SideMenuStateImplCopyWithImpl(
      _$SideMenuStateImpl _value, $Res Function(_$SideMenuStateImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$SideMenuStateImpl(
      counter: null == counter
          ? _value.counter
          : counter // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$SideMenuStateImpl implements _SideMenuState {
  _$SideMenuStateImpl({this.counter = 0});
  ...
  @override
  String toString() {
    return 'SideMenuState(counter: $counter)';
  }
...
abstract class _SideMenuState implements SideMenuState {
  factory _SideMenuState({int counter}) = _$SideMenuStateImpl;
